...
namespace BoardGameWebService.Controllers
{
    ...
    [ApiController]
    public class LobbyUserController : ControllerBase
    {
        private readonly IRedisService _redisService;
        private readonly IResponseService _responseService;
        private readonly ILogger _logger;

        public LobbyUserController(IRedisService redisService, IResponseService responseService, ILogger<LobbyUserController> logger)
        {
